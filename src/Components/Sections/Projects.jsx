...
import ProjectsGrid from '../Elements/ProjectsGrid';
const variants = {
    ini: { scaleY: 0, y: -10 },
...
const Projects = () => {
    ...
    return (
        <div className=' w-[90vw] md:ml-10 ml-2 flex flex-col ' ref={ref} id="projects">
            <div className='m-5 flex relative items-center justify-start gap-2 cursor-pointer'>
                ...
                <motion.span variants={variants} initial="ini" animate={controls2}
                    ...
                    transition={{ delay: 0.1 }} className='text-lightText  dark:text-white gap-2 md:text-5xl text-3xl font-bold text-center flex items-center justify-center'>
                    <IoBriefcase />
                    My Projects
                </motion.span>
